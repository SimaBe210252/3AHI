...
create table customer
 (cust_id INTEGER PRIMARY KEY autoincrement,
  ...
  -- sqlite braucht CHECK_Constraint:
  cust_type_cd TEXT CHECK(cust_type_cd IN ('I', 'B')) NOT NULL,
...
create table account
 (account_id integer primary key autoincrement,
  ...
  status TEXT CHECK(status IN ('ACTIVE', 'CLOSED', 'FROZEN')),
...
create table transactions
 (txn_id integer primary key autoincrement,
  ...
  txn_type_cd TEXT CHECK(txn_type_cd IN ('DBT', 'CDT')),
...
insert into transactions (txn_id, txn_date, account_id, txn_type_cd,
...
INSERT INTO employee (lname, fname, start_date) VALUES ('Ferguson', 'Sarah', '2023-01-01');
